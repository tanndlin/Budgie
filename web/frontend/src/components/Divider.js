...
function Divider() {
    ...
    const leftClassName = 'arrow h-40 w-40 -rotate-90 absolute top-[150px] left-0 float-left';
    const rightClassName = 'arrow h-40 w-40 rotate-90 absolute top-[150px] right-1/2 float-left';
    ...
    return (
        <div id='divider' className={"transition-[1s] w-full absolute right-0 group transform" + (divider_position ? null : dividerPositionClass)} onClick={() => { doMoveDivider() }}>
            <div className=''>
                ...
                <svg className={leftClassName + (divider_position && ' invisible')} viewBox="0 0 144 144">
